...
const atividades = [
  ...
  // Eventos
  {
    id: 5,
    categoria: 'eventos',
    titulo: 'Sabores, cultura e música na Várzea',
    descricao: 'Um festival gastronômico que reúne pratos tradicionais e apresentações culturais em um só lugar.',
    imagem: 'assets/panela.png',
    link: 'post-eventos.html',
  },
  {
    id: 6,
    categoria: 'eventos',
...
function criarCard(atividade) {
  ...
  card.addEventListener('click', () => {
    window.location.href = atividade.link;
  });
